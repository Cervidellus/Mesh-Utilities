...
Mesh meshutils::skel_to_mesh(const Skeleton& skeleton)
{
    Mesh mesh;
...
Mesh meshutils::color_skel_to_mesh(Skeleton& skeleton, Mesh& mesh)
{
...
bool meshutils::color_verts_from_face_property(Mesh& mesh, const Facet_with_id_pmap<double>& face_map, ColormapType colormap)
{
